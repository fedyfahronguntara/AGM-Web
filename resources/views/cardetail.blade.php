        ...
        <div class="col-12 col-md">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item main-color">Car Detail</li>
            </ol>
          </nav>
        </div>

        <div class="col-12 col-md text-center">
          <h1 class="main-color">{{ $car->name }}</h1>
          <span class="title-alt">{{ $car->location }}</span>
        </div>
      </section>
        ...
        <div class="row" style="margin-top: 120px">
          <div class="col-12 col-md-12 col-lg-7 mb-5">
            <div class="card border-0 p-2">
              <h3 class="fw-bolder title mb-4">Car Detail</h3>
              
              <span class="d-flex mb-3"><i class='bx bxs-gas-pump main-color fs-4 me-3 '></i> <strong>Driver + BBM</strong> </span> 
              <span class="d-flex"><i class='bx bx-male main-color fs-4 me-3' ></i> <strong>{{ $car->duration }}</strong></span>
            ...
            <div class="card bordered card-form" style="padding: 30px 40px">
              ...
              >
                ...
                <span class="text-gray-500 font-weight-light"
                  >IDR.{{ number_format($car->price) }}</span
                >
              </div>
             ...
             <div class="card-bank d-flex align-items-center justify-content-around">
                ...
                <div class="card-bank-content d-flex flex-column">
                  <span>PT ANJHANI GILI MAS</span>
                  <b>1234567890</b>
                </div>
             </div>
              <!-- <a onClick="return confirm('Apakah anda sudah membayar ?')" class="btn btn-book btn-block mt-3" href="https://api.whatsapp.com/send?phone=6281999483864&text= Saya mau pesan paket travel {{ $car->name }} berikut bukti pembayaran saya ! " target="_blank"
                >Continue to Book</a
              > -->
                      <form action="{{route('orderdetail',$car)}}" method="POST" >
    @csrf
              <!-- <a href="{{ route('orderdetail', $car) }}" class="btn mt-4 btn-book">Continue to Book</a> -->
...
<button type="submit" class="btn btn-primary btn-block">Continue to Book</button> 
        </form>    
        </div>
          </div>
        </div>
