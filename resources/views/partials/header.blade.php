      ...
      <nav class="nav container">
        <a href="{{ route('home') }}" class="nav__logo"
          ><img
            ...
            src="{{ asset('frontend/assets/images/logofix__.png') }}"
            alt=""
        /></a>
        ...
        <div class="nav__menu" id="nav-menu">
          <ul class="nav__list">
            ...
            <li class="nav__item">
              <a href="{{ route('ordersearch') }}" class="nav__link {{ request()->is('paket-travel') ? ' active-link' : '' }}">
                <i class="bx bx-briefcase-alt nav__icon"></i>
                <span class="nav__name">Status Track</span>
              </a>
            </li>
